...
│                                                      │
│   mock-to-react          criador-de-apps             │
│  (visual → código)      (MVP rápido)                 │
│                                                      │
│              app-factory-multiagent                  │
│             (app robusto e completo)                 │
└─────────────────────────────────────────────────────┘
↓
┌──────────────────────────────────────────────┐
│              Camada de Validação              │
...
**criador-de-apps**
- ideia → MVP rápido
- baixo overhead, alta velocidade
- saída: estrutura de projeto funcional
...
mock-to-react     → preview-bridge | app-factory
criador-de-apps   → preview-bridge | surge-core
app-factory       → preview-bridge | surge-core | engineering-mentor
preview-bridge    → surge-core
surge-core        → core-orchestrator | engineering-mentor
engineering-mentor→ core-orchestrator | app-factory | criador-de-apps
```
